...
if __name__ == '__main__':
    ...
    # The four modes defining how the CPPO position weight w_t is calculated
    weight_modes = ["heuristic", "meta_learning", "option_critic", "epistemic_prm"]
    
    budget = 2.5 

    base_dir = "/network/scratch/g/guangyuan.wang/credit_assignment/OPSD"  
    job_script_directory = os.path.join(base_dir, "temp_job_scripts_weights")
    out_dir = os.path.join(base_dir, "grpo_cppo", "logs_weights")
    ...
    for i, mode in enumerate(weight_modes):
        ...
        run_name = f"exp_weights_qwen4b_{mode}".replace(".", "p")
        ...
        bash_run_command = (
            ...
            f"--wandb_project GRPO_CPPO_Weight_Learning "
...
'''
    ...
    print(f"Total Experiment Position Weights sweeps submitted to SLURM: {submitted_jobs}")